...
async def auto_filter(bot: Client, update: Message):
    ...
    show_invite = configs["configs"]["pm_file_chat"] # should or not show active chat invite link
    ...
    if len(results) == 0: # double check
        ...
        try:
            await bot.send_message(
                ...
                text=f"🔗Check Links @MRflicks✔️..Found {(len_results)} Results For Your Request: <code>{query}</code>",
